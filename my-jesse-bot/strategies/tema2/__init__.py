...
class TEMATrendFollowing(Strategy):
    ...
    def long_term_trend(self):
        ...
        tema20 = ta.tema(self.candles_4h, 20)
        tema70 = ta.tema(self.candles_4h, 70)
    ...
    @property
    def tema20_4h(self):
        return ta.tema(self.candles_4h, 20)
    
    @property
    def tema70_4h(self):
        return ta.tema(self.candles_4h, 70)
    ...
    def go_long(self):
        ...
        # Risk 9% of available margin (3% × 3 multiplier for higher returns)
        qty = utils.risk_to_qty(self.available_margin, 3, entry_price, stop_loss_price, fee_rate=self.fee_rate)
        
        # Place the order with 3x position size
    ...
    def go_short(self):
        ...
        # Risk 3% of available margin - FIXED: Removed qty*3 multiplication
        qty = utils.risk_to_qty(self.available_margin, 3, entry_price, stop_loss_price, fee_rate=self.fee_rate)
